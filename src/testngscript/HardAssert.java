...
public class HardAssert {
	...
	/* if assert is failed then it will stop the method execution process
	 * 
	 */
	...
	@Test(priority=0)
	 ...
	 public static void Test2() {
		  ...
		  Assert.assertEquals("hello","hello world","expected text is not matching with actual text");
